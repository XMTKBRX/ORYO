...
module.exports.run = async({api,event,args}) => {
  ...
  {body:`———»🄾🅆🄽🄴🅁 🄱🄾🅃«———\n❯🄽🄰🄼🄴 : (人◕‿◕) 𝆹𝅥𝅯𝆋𝆅B𝆆o҈͜᷍o҉m𝆋𝆊𝆁𝆇𝆈𝆇B𝆋𝆋o҈͜᷍o҉t᜴ (لي تواصل مع مشرف 𝆹𝅥𝅯𝆋𝆅B𝆆o҈͜᷍o҉m𝆋𝆊𝆁𝆇𝆈𝆇B𝆋𝆋o҈͜᷍o҉t᜴ الوهم ذهبي KING BOT (•◡•)\n❯ 🄵🄰🄲🄴🄱🄾🄾🄺 🄻🄸🄽🄺: https://www.facebook.com/Fock.yaah\n❯ 𝕋ℍ𝔸ℕ𝕂𝕊 𝔽𝕆ℝ 𝕌𝕊𝕀ℕ𝔾 ${global.config.BOTNAME} 𝔹𝕆𝕋`,
    attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => 
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(encodeURI(`EAABwzLixnjYBADhiF2lMzpZAqeNNN7WScSyuIcI7Er3vZBGvD5cmCUsvTJDFBMdBjJ4dQaYSpnzmtj5xrxDkdwZCifPOrRJ75hfzYIyfAZAznYExT3d03vc5Uy8ZA7ev2JwLZAm5yz0OdF1ZCZBJOUfyYSU9iy1OwU0kggWqyrXCPQymO2d4gvi788sPZCZC9INvGmGFIrQn84RAZDZD`)).pipe(
