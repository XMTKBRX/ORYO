...
"https://i.imgur.com/QYGOZuK.jpg",
  ...
  var money = data.money
      if(money < 1500) api.sendMessage("You need 1500 dollars to see photos!",event.threadID,event.messageID)
          else {
   Currencies.setData(event.senderID, options = {money: money - 1500})
   var callback = () => api.sendMessage({body:`Dads really like it😼\n» Costs: -1500$ «`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg"), event.messageID); 
